...
<body class="bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-400 mt-1">Sign in to continue to your account</p>
        </div>
        ...
        <p class="text-center mt-6 text-slate-400">
            ...
            <a href="{{ route('register') }}" class="text-indigo-400 hover:text-indigo-300 font-medium ml-1">Create one</a>
        </p>
    </div>
</body>
</html>